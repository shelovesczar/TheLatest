  ...
  const prevSlide = () => {
    ...
    setCurrentIndex((prev) => {
      if (prev === 0) {
        ...
        const lastPageStart =
          Math.floor((safeOpinions.length - 1) / itemsPerPage) * itemsPerPage;
      ...
      {loadingOpinions ? (
        ...
        <>
                  ...
                  >
                    ...
                    <div className="card-body-inner">
                      ...
                      <div className="card-excerpt">
                        {truncateText(opinion.description, 160)}
                      </div>
          ...
          <div className="section-see-more-row">
            <Link to={categoryPath || "/all-opinions"} className="see-more">
              See more opinions →
            </Link>
          </div>
        </>
        ...
        <p className="no-content">
          No opinion articles available at this time.
        </p>
      )}
    </section>
  );
