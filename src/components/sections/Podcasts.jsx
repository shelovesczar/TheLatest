  ...
  const prevSlide = () => {
    ...
    setCurrentIndex((prev) => {
      if (prev === 0) {
        ...
        const lastPageStart =
          Math.floor((safePodcasts.length - 1) / itemsPerPage) * itemsPerPage;
      ...
      {loadingPodcasts ? (
        ...
        <>
                  ...
                  >
                    ...
                    <div className="card-body-inner">
                      ...
                      <div className="card-excerpt">
                        {truncateText(podcast.description, 140)}
                      </div>
          ...
          <div className="section-see-more-row">
            <Link to={categoryPath || "/all-podcasts"} className="see-more">
              View all podcasts →
            </Link>
          </div>
        </>
