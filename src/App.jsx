...
const EditorialStandardsPage = lazy(
...
function App() {
  ...
  const handleBreakingNewsChange = useCallback((nextBreakingNews = []) => {
    setBreakingNews((currentBreakingNews) => {
      ...
      if (
        currentBreakingNews.length === normalizedNext.length &&
        currentBreakingNews.every(
          (headline, index) => headline === normalizedNext[index],
        )
      ) {
              ...
              <ErrorBoundary>
                <Suspense fallback={<RouteLoader />}>
                  <Routes>
                    ...
                    />
                    <Route
                      path="/topic/:topicSlug/all-opinions"
                      element={<AllOpinionsPage />}
                    />
                    <Route
                      path="/topic/:topicSlug/all-videos"
                      element={<AllVideosPage />}
                    />
                    <Route
                      path="/topic/:topicSlug/all-podcasts"
                      element={<AllPodcastsPage />}
                    />

                    {/* Category-specific All pages */}
                    <Route
                      path="/category/:categoryName/all-news"
                      element={<AllNewsPage />}
                    />
                    <Route
                      path="/category/:categoryName/all-opinions"
                      element={<AllOpinionsPage />}
                    />
                    <Route
                      path="/category/:categoryName/all-videos"
                      element={<AllVideosPage />}
                    />
                    <Route
                      path="/category/:categoryName/all-podcasts"
                      element={<AllPodcastsPage />}
                    />
                    ...
                    <Route
                      ...
                      element={<CategoryPage category="top-stories" />}
                    />
                    <Route
                      path="/category/business-tech"
                      element={<CategoryPage category="business-tech" />}
                    />
                    <Route
                    ...
                    <Route
                      ...
                      element={<CategoryPage category="culture" />}
                    />
