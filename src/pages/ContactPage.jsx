    ...
    <main className="legal-page">
      <section className="legal-page__hero">
        ...
        <h1 className="legal-page__title">
          Questions are useful only if they reach the right queue.
        </h1>
        <p className="legal-page__lede">
          Contact The Latest for editorial questions, product issues, privacy
          requests, or corrections. Route-specific details help us fix problems
          faster.
        </p>
