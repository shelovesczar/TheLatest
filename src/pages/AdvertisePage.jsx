...
import { ADVERTISING_EMAIL } from "../utils/siteConfig";
...
const sections = [
  ...
  },
  {
    ...
    body: [
      `Send advertising inquiries to ${ADVERTISING_EMAIL} with the subject line "Advertising Inquiry." We can route brand, agency, sponsorship, and custom placement requests from there until a dedicated sales inbox is published.`,
    ],
  },
];
    ...
    <main className="legal-page">
      <section className="legal-page__hero">
        ...
        <h1 className="legal-page__title">
          Reach readers where breaking news, analysis, and media discovery
          actually happen.
        </h1>
        <p className="legal-page__lede">
          The Latest offers advertising opportunities across a fast-moving
          editorial product built for high-signal reading, topic discovery, and
          repeat daily usage.
        </p>
      ...
      <section className="legal-page__content">
        <aside
          ...
          aria-label="Advertising page sections"
        >
