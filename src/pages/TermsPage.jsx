...
import { LEGAL_EMAIL } from "../utils/siteConfig";
    ...
    <main className="legal-page">
      <section className="legal-page__hero">
        ...
        <h1 className="legal-page__title">
          The platform stays usable only if access and behavior stay bounded.
        </h1>
        <p className="legal-page__lede">
          These terms define the rules for access, account use, platform
          behavior, content handling, and the limits of responsibility across
          The Latest.
        </p>
        <div className="legal-page__meta">
          <span>Effective date: June 17, 2026</span>
          <span>
            Applies to web, authenticated, and administrative product surfaces
          </span>
        </div>
      </section>
