...
import { PRIVACY_EMAIL } from "../utils/siteConfig";
    ...
    <main className="legal-page">
      <section className="legal-page__hero">
        ...
        <h1 className="legal-page__title">
          Your account data should support the product, not undermine trust.
        </h1>
        <p className="legal-page__lede">
          This policy covers how The Latest collects, uses, stores, and protects
          information tied to reading, search, account, and analytics features
          across the platform.
        </p>
        ...
        <div className="legal-page__sections">
          ...
          <section className="legal-page__contact">
            ...
            <p className="legal-page__paragraph">
              For access, deletion, correction, or security questions, contact{" "}
