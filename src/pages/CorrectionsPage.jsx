...
import { CORRECTIONS_EMAIL } from "../utils/siteConfig";
    ...
    <main className="legal-page">
      <section className="legal-page__hero">
        ...
        <h1 className="legal-page__title">
          Trust improves only if mistakes can be reported and fixed.
        </h1>
        <p className="legal-page__lede">
          This page explains how to flag factual, routing, labeling, or
          generated-content issues and how The Latest handles corrections when
          they affect the product.
        </p>
        <div className="legal-page__meta">
          <span>Correction workflow</span>
          <span>
            Applies to editorial framing, metadata, and generated fallback
            content
          </span>
        </div>
      </section>
        ...
        <div className="legal-page__sections">
          ...
          <section className="legal-page__contact">
            ...
            <p className="legal-page__paragraph">
              Send the story URL, a short description, and any supporting source
              to <a href={`mailto:${CORRECTIONS_EMAIL}`}>{CORRECTIONS_EMAIL}</a>
              .
            </p>
          </section>
        </div>
