...
export const SOURCE_REGISTRY = [
  {
    displayName: "Reuters",
    names: ["reuters", "reuters world", "reuters business", "reuters tv"],
    slug: "reuters",
  ...
  },
  {
    ...
    names: ["associated press", "ap", "ap news", "associated press video"],
  ...
  {
    displayName: "NPR",
    names: ["npr", "national public radio", "npr books", "npr politics"],
    slug: "npr",
  ...
  },
  {
    ...
    names: ["fox news", "fox news politics"],
    slug: "fox-news",
  ...
  },
  {
    ...
    names: ["yahoo news", "yahoo", "yahoo sports"],
    slug: "yahoo-news",
  ...
  },
  {
    ...
    names: ["al jazeera english"],
    slug: "al-jazeera-english",
    homepage: "https://www.aljazeera.com",
    country: "Qatar",
    founded: "1996",
    ownershipName: "Al Jazeera Media Network",
    ownershipType: "Government-funded international broadcaster",
    ownershipSummary:
      "Funded by the government of Qatar through the Al Jazeera Media Network.",
    fundingModel: "State funding via the Qatari government.",
    perspectiveKey: "left",
    perspectiveLabel: "Left-Center",
    factualityLabel: "Mixed to high factuality",
    description:
      "International news coverage with a particular focus on the Middle East, Africa, and global affairs.",
    methodologyNote:
      "MBFC and AllSides both classify Al Jazeera English as Left-Center bias with generally high factual reporting, though its state funding is noted as a factor in coverage of Gulf-region politics.",
  },
  {
    displayName: "All Things Considered",
    names: ["all things considered"],
    slug: "all-things-considered",
    homepage: "https://www.npr.org/programs/all-things-considered/",
    country: "United States",
    founded: "1971",
    ownershipName: "NPR",
    ownershipType: "Public broadcaster",
    ownershipSummary:
      "NPR's flagship afternoon news program, produced and distributed by NPR.",
    fundingModel: "Member station dues, corporate sponsorship, and grants.",
    perspectiveKey: "left",
    perspectiveLabel: "Left-Center",
    factualityLabel: "High factuality",
    description:
      "NPR's flagship afternoon news program covering national and international news, politics, and culture with in-depth reporting and interviews.",
    methodologyNote:
      "AllSides and MBFC both rate NPR (and its flagship programs) as Left-Center bias with high factual reporting.",
  },
  {
    displayName: "Morning Edition",
    names: ["morning edition"],
    slug: "morning-edition",
    homepage: "https://www.npr.org/programs/morning-edition/",
    country: "United States",
    founded: "1979",
    ownershipName: "NPR",
    ownershipType: "Public broadcaster",
    ownershipSummary:
      "NPR's flagship morning news program, produced and distributed by NPR.",
    fundingModel: "Member station dues, corporate sponsorship, and grants.",
    perspectiveKey: "left",
    perspectiveLabel: "Left-Center",
    factualityLabel: "High factuality",
    description:
      "NPR's flagship morning news program delivering national and international news, interviews, and features with a measured, journalistic tone.",
    methodologyNote:
      "Rated Left-Center by AllSides and Media Bias Fact Check consistent with NPR's overall network rating.",
  },
  {
    displayName: "NPR Up First",
    names: ["npr up first"],
    slug: "npr-up-first",
    homepage: "https://www.npr.org/podcasts/510318/up-first",
    country: "United States",
    founded: "2017",
    ownershipName: "National Public Radio (NPR)",
    ownershipType: "Public broadcaster",
    ownershipSummary:
      "Daily news podcast produced by NPR's news division.",
    fundingModel: "Member station dues, corporate sponsorship, and grants.",
    perspectiveKey: "left",
    perspectiveLabel: "Left-Center",
    factualityLabel: "High factuality",
    description:
      "A daily news podcast from NPR summarizing top national and world headlines in a concise, straightforward broadcast style.",
    methodologyNote:
      "NPR's news division is rated Left-Center by AllSides and MBFC with a High factuality rating, and this consensus is applied to its Up First podcast as an extension of NPR's news programming.",
  },
  {
    displayName: "The Ezra Klein Show",
    names: ["the ezra klein show"],
    slug: "the-ezra-klein-show",
    homepage: "https://www.nytimes.com/column/ezra-klein-podcast",
    country: "United States",
    founded: "2016",
    ownershipName: "The New York Times Company",
    ownershipType: "Public company division",
    ownershipSummary:
      "Opinion podcast produced under The New York Times Opinion section.",
    fundingModel: "Subscriptions and advertising via The New York Times.",
    perspectiveKey: "left",
    perspectiveLabel: "Left-Center",
    factualityLabel: "Mixed to high factuality",
    description:
      "A long-form interview and opinion podcast hosted by journalist Ezra Klein covering politics, policy, and ideas from a left-of-center analytical perspective.",
    methodologyNote:
      "Classified as Left-Center consistent with MBFC and AllSides assessments of Ezra Klein's commentary and its home at The New York Times Opinion section.",
  },
  {
    displayName: "The Intelligence - The Economist",
    names: ["the intelligence - economist", "the intelligence - the economist"],
    slug: "the-intelligence-the-economist",
    homepage: "https://www.economist.com/the-intelligence",
    country: "United Kingdom",
    founded: "2018",
    ownershipName: "The Economist Group",
    ownershipType: "Private company",
    ownershipSummary:
      "Daily news podcast produced by The Economist.",
    fundingModel: "Subscriptions and advertising via The Economist Group.",
    perspectiveKey: "center",
    perspectiveLabel: "Left-Center",
    factualityLabel: "High factuality",
    description:
      "A daily news podcast from The Economist offering analysis of global politics, business, and current events in a measured, editorial voice.",
    methodologyNote:
      "MBFC and AllSides classify The Economist as Left-Center with high factual reporting, consistent with the parent publication's tracker consensus.",
  },
  {
    displayName: "VOA In The News",
    names: ["voa in the news"],
    slug: "voa-in-the-news",
    homepage: "https://www.voanews.com",
    country: "United States",
    founded: "1942",
    ownershipName: "U.S. Agency for Global Media",
    ownershipType: "Government-funded international broadcaster",
    ownershipSummary:
      "Voice of America is chartered and funded by the U.S. federal government.",
    fundingModel: "U.S. federal government funding.",
    perspectiveKey: "center",
    perspectiveLabel: "Center",
    factualityLabel: "High factuality",
    description:
      "A news digest podcast from Voice of America presenting U.S. government-funded international news coverage in a straightforward reporting style.",
    methodologyNote:
      "MBFC and AllSides consensus rates Voice of America as Center for bias and High for factual reporting, consistent with its charter mandate for balanced journalism.",
  },
  {
    displayName: "Weekend Edition Saturday",
    names: ["weekend edition saturday"],
    slug: "weekend-edition-saturday",
    homepage: "https://www.npr.org/programs/weekend-edition-saturday/",
    country: "United States",
    founded: "1985",
    ownershipName: "NPR",
    ownershipType: "Public broadcaster",
    ownershipSummary:
      "Weekend NPR news program produced and distributed by NPR.",
    fundingModel: "Member station dues, corporate sponsorship, and grants.",
    perspectiveKey: "left",
    perspectiveLabel: "Left-Center",
    factualityLabel: "High factuality",
    description:
      "A weekend NPR news program covering national and international news, interviews, and features with a measured, public-radio editorial voice.",
    methodologyNote:
      "Classified consistent with AllSides and MBFC's Left-Center, high-factuality rating for NPR's news programming.",
  },
  {
    displayName: "Weekend Edition Sunday",
    names: ["weekend edition sunday"],
    slug: "weekend-edition-sunday",
    homepage: "https://www.npr.org/programs/weekend-edition-sunday/",
    country: "United States",
    founded: "1987",
    ownershipName: "NPR",
    ownershipType: "Public broadcaster",
    ...
    factualityLabel: "High factuality",
    description:
      "A weekly NPR news program featuring interviews, analysis, and features on national and international current events.",
    methodologyNote:
      "AllSides and MBFC consistently rate NPR's news programming as Left-Center with high factual reporting standards.",
  },
  {
    displayName: "PJ Media",
    names: ["pj media"],
    slug: "pj-media",
    homepage: "https://pjmedia.com",
    country: "United States",
    founded: "2005",
    ownershipName: "Salem Media Group",
    ownershipType: "Public company division",
    ownershipSummary:
      "Conservative opinion and commentary site owned by Salem Media Group.",
    fundingModel: "Advertising and Salem Media Group syndication.",
    perspectiveKey: "right",
    perspectiveLabel: "Right",
    factualityLabel: "Mixed factuality",
    description:
      "An opinion-driven conservative commentary site covering politics and culture, filed here under an entertainment RSS category despite its political focus.",
    methodologyNote:
      "AllSides and Media Bias Fact Check both rate PJ Media as Right, with Mixed factuality reflecting its opinion-first, lightly-sourced commentary format.",
  },
  {
    displayName: "This American Life",
    names: ["this american life"],
    slug: "this-american-life",
    homepage: "https://www.thisamericanlife.org",
    country: "United States",
    founded: "1995",
    ownershipName: "WBEZ Chicago / Public Radio Exchange (PRX)",
    ownershipType: "Nonprofit media organization",
    ownershipSummary:
      "Produced by WBEZ Chicago and distributed by PRX; not an NPR production, though widely carried on public radio.",
    fundingModel: "Member station dues, listener support, and grants.",
    perspectiveKey: "left",
    perspectiveLabel: "Left-Center",
    factualityLabel: "High factuality",
    description:
      "A long-running narrative journalism and storytelling program covering personal stories, social issues, and current events.",
    methodologyNote:
      "MBFC rates This American Life as Left-Center bias with High factuality, reflecting its narrative journalism approach and occasional editorial framing on social issues.",
  },
  {
    displayName: "The Daily Zeitgeist",
    names: ["the daily zeitgeist"],
    slug: "the-daily-zeitgeist",
    homepage: "https://www.iheart.com/podcast/105-the-daily-zeitgeist-27581956/",
    country: "United States",
    founded: "2015",
    ownershipName: "iHeartMedia",
    ownershipType: "Public company division",
    ownershipSummary:
      "Comedy news podcast distributed via iHeartPodcasts.",
    fundingModel: "Advertising via iHeartMedia's podcast network.",
    perspectiveKey: "left",
    perspectiveLabel: "Left",
    factualityLabel: "Mixed factuality",
    description:
      "A daily comedy podcast discussing news and current events with a satirical, opinion-driven format.",
    methodologyNote:
      "Media Bias Fact Check classifies this podcast as Left with Mixed factuality due to its opinion/comedy format and satirical framing of news.",
  },
  {
    ...
    country: "United States",
    founded: "2009",
    ownershipName: "Hyperallergic Media Inc.",
    ownershipType: "Independent",
    ownershipSummary:
      "Independently owned art and culture publication.",
    fundingModel: "Advertising, membership, and sponsored content.",
    perspectiveKey: "left",
    perspectiveLabel: "Left",
    factualityLabel: "Mixed factuality",
    description:
      "An arts and culture publication covering the visual art world with frequent political and social commentary from a progressive editorial voice.",
    methodologyNote:
      "Media Bias Fact Check rates Hyperallergic as Left bias with Mixed factual reporting, reflecting its story selection and opinion-inflected art criticism on political topics.",
  },
  {
    displayName: "ARTnews",
    names: ["artnews"],
    slug: "artnews",
    homepage: "https://www.artnews.com",
    country: "United States",
    founded: "1902",
    ownershipName: "Penske Media Corporation",
    ownershipType: "Private company",
    ownershipSummary: "Trade publication owned by Penske Media Corporation.",
    fundingModel: "Advertising and subscriptions.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Industry reporting",
    description:
      "ARTnews covers the visual art world, including gallery and museum news, art market trends, and artist profiles.",
    methodologyNote:
      "As an arts/culture trade publication, ARTnews is not rated by AllSides, Ad Fontes Media, or MBFC for political lean, so no perspective label applies.",
  },
  {
    ...
    country: "United States",
    founded: "2009",
    ownershipName: "Atlas Obscura, Inc.",
    ownershipType: "Private company",
    ownershipSummary: "Independently owned travel and culture publication.",
    fundingModel: "Advertising, tours, and experiences revenue.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Mixed to high factuality",
    description:
      "Atlas Obscura covers curious, hidden, and offbeat travel destinations, historical oddities, and cultural phenomena with a curious, exploratory editorial voice.",
    methodologyNote:
      "No political lean applies; Atlas Obscura is a travel/culture publication not rated by AllSides, Ad Fontes, or MBFC for political bias.",
  },
  {
    displayName: "Better Nutrition",
    names: ["better nutrition"],
    slug: "better-nutrition",
    homepage: "https://www.betternutrition.com",
    country: "United States",
    founded: "1969",
    ownershipName: "Active Interest Media",
    ownershipType: "Private company",
    ownershipSummary: "Consumer health magazine owned by Active Interest Media.",
    fundingModel: "Advertising and subscriptions.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Industry reporting",
    description:
      "A health and wellness magazine focused on nutrition, supplements, and natural living, with a consumer-advocacy editorial voice.",
    methodologyNote:
      "No political lean applies as this is a lifestyle/health publication not rated by AllSides, Ad Fontes Media, or MBFC for political bias.",
  },
  {
    ...
    country: "United States",
    founded: "1956",
    ownershipName: "Condé Nast",
    ownershipType: "Public company division",
    ownershipSummary: "Food and lifestyle publication owned by Condé Nast.",
    fundingModel: "Advertising and subscriptions.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Industry reporting",
    description:
      "Bon Appétit covers food culture, recipes, cooking techniques, and restaurant trends with a lifestyle-focused editorial voice.",
    methodologyNote:
      "No political lean applies as this is a food/lifestyle publication not rated by AllSides, Ad Fontes Media, or MBFC for political bias.",
  },
  {
    ...
    country: "United States",
    founded: "2007",
    ownershipName: "Complex Networks (Valence Media)",
    ownershipType: "Private company",
    ownershipSummary: "Entertainment and music outlet owned by Complex Networks.",
    fundingModel: "Advertising.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Industry reporting",
    description:
      "An entertainment and music-focused outlet covering album reviews, film/TV news, and pop culture with a fan-oriented, critical voice.",
    methodologyNote:
      "Entertainment/arts publication with no meaningful political lean; not rated by AllSides, Ad Fontes Media, or MBFC.",
  },
  {
    displayName: "DW - Global 3000",
    names: ["deutsche welle - global 3000", "dw - global 3000"],
    slug: "dw-global-3000",
    homepage: "https://www.dw.com/en/global-3000/s-32897",
    country: "Germany",
    founded: "2009",
    ownershipName: "Deutsche Welle",
    ownershipType: "Government-funded international broadcaster",
    ownershipSummary:
      "Documentary/magazine series produced by Deutsche Welle, Germany's public international broadcaster.",
    fundingModel: "German federal government funding.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "High factuality",
    description:
      "A DW documentary/magazine podcast covering globalization, environment, development, and social issues around the world.",
    methodologyNote:
      "This is a lifestyle/society/environment-focused documentary series rather than general news or opinion, so AllSides/MBFC do not assign it a political lean.",
  },
  {
    displayName: "Elle",
    names: ["elle"],
    slug: "elle",
    homepage: "https://www.elle.com",
    country: "United States",
    founded: "1945",
    ownershipName: "Hearst Communications",
    ownershipType: "Private company",
    ownershipSummary: "Fashion and lifestyle publication owned by Hearst.",
    fundingModel: "Advertising and subscriptions.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Industry reporting",
    description:
      "Elle covers fashion, beauty, culture, and lifestyle topics with a stylish, trend-focused editorial voice.",
    methodologyNote:
      "Lifestyle and fashion outlets like Elle are not rated for political lean by AllSides, Ad Fontes Media, or MBFC, so no perspective label applies.",
  },
  {
    displayName: "Fresh Air",
    names: ["fresh air"],
    slug: "fresh-air",
    homepage: "https://www.npr.org/programs/fresh-air/",
    country: "United States",
    founded: "1975",
    ownershipName: "WHYY / NPR",
    ownershipType: "Nonprofit media organization",
    ownershipSummary:
      "Produced by WHYY in Philadelphia and distributed by NPR.",
    fundingModel: "Member station dues, corporate sponsorship, and grants.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "High factuality",
    description:
      "A long-running interview program hosted by Terry Gross covering arts, culture, books, film, and public affairs guests in an in-depth conversational format.",
    methodologyNote:
      "AllSides/MBFC do not assign a political lean to this arts and culture interview program, so no perspective label applies.",
  },
  {
    displayName: "LA Times Lifestyle",
    names: ["la times lifestyle"],
    slug: "la-times-lifestyle",
    homepage: "https://www.latimes.com/lifestyle",
    country: "United States",
    founded: "",
    ownershipName: "Nant Capital (Patrick Soon-Shiong)",
    ownershipType: "Private company",
    ownershipSummary:
      "Lifestyle section of the Los Angeles Times, owned by Nant Capital.",
    fundingModel: "Advertising and subscriptions.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Mixed to high factuality",
    description:
      "A lifestyle section covering food, wellness, relationships, home, and culture topics from the Los Angeles Times.",
    methodologyNote:
      "Lifestyle content does not carry a political lean and is not rated by AllSides, Ad Fontes Media, or Media Bias Fact Check as a distinct feed.",
  },
  {
    displayName: "Literary Hub",
    names: ["literary hub"],
    slug: "literary-hub",
    homepage: "https://lithub.com",
    country: "United States",
    founded: "2015",
    ownershipName: "Grove Atlantic",
    ownershipType: "Private company",
    ownershipSummary: "Literary culture site backed by Grove Atlantic.",
    fundingModel: "Advertising and publisher partnerships.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Industry reporting",
    description:
      "A literary culture site featuring book excerpts, essays, author interviews, and criticism aimed at readers and writers.",
    methodologyNote:
      "Literary Hub is a books/culture publication not rated by AllSides, Ad Fontes Media, or MBFC for political lean, as it falls outside general news/politics coverage.",
  },
  {
    displayName: "Men's Health",
    names: ["men's health"],
    slug: "mens-health",
    homepage: "https://www.menshealth.com",
    country: "United States",
    founded: "1987",
    ownershipName: "Hearst Communications",
    ownershipType: "Private company",
    ownershipSummary: "Men's lifestyle magazine owned by Hearst.",
    fundingModel: "Advertising and subscriptions.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Varies by channel",
    description:
      "A men's lifestyle magazine covering fitness, health, nutrition, style, and relationships with a practical, service-journalism voice.",
    methodologyNote:
      "No political lean applies as this is a lifestyle/health publication not rated by AllSides, Ad Fontes Media, or MBFC for political bias.",
  },
  {
    displayName: "Metacritic Movies",
    names: ["metacritic movies"],
    slug: "metacritic-movies",
    homepage: "https://www.metacritic.com/movie/",
    country: "United States",
    founded: "2001",
    ownershipName: "Fandom, Inc.",
    ownershipType: "Private company",
    ownershipSummary: "Review-aggregation site owned by Fandom, Inc.",
    fundingModel: "Advertising.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Aggregation layer",
    description:
      "Metacritic Movies aggregates and averages critic and user reviews of films to produce composite scores, with no original political or news reporting.",
    methodologyNote:
      "Not rated by AllSides, Ad Fontes Media, or MBFC as it is an entertainment review-aggregation outlet with no meaningful political lean.",
  },
  {
    displayName: "National Geographic Travel",
    names: ["national geographic travel"],
    slug: "national-geographic-travel",
    homepage: "https://www.nationalgeographic.com/travel",
    country: "United States",
    founded: "1888",
    ownershipName: "The Walt Disney Company",
    ownershipType: "Public company division",
    ownershipSummary:
      "Travel vertical of National Geographic, owned by The Walt Disney Company.",
    fundingModel: "Advertising and subscriptions.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "High factuality",
    description:
      "A travel-focused vertical of National Geographic offering destination guides, travel photography, and adventure/culture features rather than political news.",
    methodologyNote:
      "Lifestyle/travel outlets like this are not rated by AllSides, Ad Fontes Media, or MBFC for political lean, so no perspective label is applied.",
  },
  {
    displayName: "Outside",
    names: ["outside"],
    ...
    country: "United States",
    founded: "1977",
    ownershipName: "Outside Interactive, Inc.",
    ownershipType: "Private company",
    ownershipSummary: "Independently owned outdoor recreation publication.",
    fundingModel: "Advertising and subscriptions.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Mixed to high factuality",
    description:
      "Outside covers outdoor recreation, adventure travel, fitness, gear reviews, and environmental topics with a lifestyle-oriented editorial voice.",
    methodologyNote:
      "No political lean applies; this is a lifestyle/outdoor recreation publication not rated by AllSides, Ad Fontes, or MBFC for political bias.",
  },
  {
    displayName: "Pop Culture Happy Hour",
    names: ["pop culture happy hour"],
    slug: "pop-culture-happy-hour",
    homepage: "https://www.npr.org/podcasts/510023/pop-culture-happy-hour",
    country: "United States",
    founded: "2010",
    ownershipName: "NPR",
    ownershipType: "Nonprofit media organization",
    ownershipSummary: "Pop-culture podcast produced by NPR.",
    fundingModel: "Member station dues, corporate sponsorship, and grants.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Industry reporting",
    description:
      "An NPR podcast offering casual, conversational reviews and discussion of movies, TV, books, music, and other pop culture topics.",
    methodologyNote:
      "This is an arts/culture and entertainment podcast with no general news or political coverage, so AllSides/Ad Fontes/MBFC do not rate it for political lean.",
  },
  {
    displayName: "ProFootballTalk",
    names: ["profootballtalk"],
    slug: "profootballtalk",
    homepage: "https://profootballtalk.nbcsports.com",
    country: "United States",
    founded: "2007",
    ownershipName: "NBCUniversal",
    ownershipType: "Public company division",
    ownershipSummary: "NFL news site owned by NBCUniversal.",
    fundingModel: "Advertising.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Industry reporting",
    description:
      "ProFootballTalk covers NFL news, rumors, and analysis with a fan- and insider-focused editorial voice.",
    methodologyNote:
      "This is a sports outlet with no meaningful political lean, so AllSides/Ad Fontes/MBFC do not rate it and no perspective label applies.",
  },
  {
    displayName: "ScienceDaily Health",
    names: ["sciencedaily health"],
    slug: "sciencedaily-health",
    homepage: "https://www.sciencedaily.com/news/health_medicine/",
    country: "United States",
    founded: "1995",
    ownershipName: "ScienceDaily LLC",
    ownershipType: "Private company",
    ownershipSummary: "Research-news aggregator operated by ScienceDaily LLC.",
    fundingModel: "Advertising.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "High factuality",
    description:
      "Aggregates and summarizes press releases and research findings from universities and research institutions on health and medical science topics.",
    methodologyNote:
      "Health/science news aggregators are not rated by AllSides, Ad Fontes Media, or MBFC for political lean, as their content is research-based rather than political.",
  },
  {
    displayName: "SELF",
    names: ["self"],
    slug: "self-magazine",
    homepage: "https://www.self.com",
    country: "United States",
    founded: "1979",
    ownershipName: "Condé Nast",
    ownershipType: "Public company division",
    ownershipSummary: "Health and wellness lifestyle title owned by Condé Nast.",
    fundingModel: "Advertising and subscriptions.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Mixed to high factuality",
    description:
      "SELF is a lifestyle publication covering health, fitness, nutrition, and wellness topics for a general consumer audience.",
    methodologyNote:
      "As a lifestyle/health outlet, SELF is not rated for political lean by AllSides, Ad Fontes Media, or MBFC, so no perspective label applies.",
  },
  {
    displayName: "TED Radio Hour",
    names: ["ted radio hour"],
    slug: "ted-radio-hour",
    homepage: "https://www.npr.org/podcasts/510298/ted-radio-hour",
    country: "United States",
    founded: "2012",
    ownershipName: "NPR",
    ownershipType: "Nonprofit media organization",
    ownershipSummary: "Ideas/culture podcast produced by NPR in partnership with TED.",
    fundingModel: "Member station dues, corporate sponsorship, and grants.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "High factuality",
    description:
      "A public radio/podcast program that explores ideas, science, and culture through curated excerpts and interviews from TED Talks.",
    methodologyNote:
      "This is an ideas/science/culture program rather than general news or opinion coverage, so no political lean rating applies per AllSides/MBFC methodology.",
  },
  {
    displayName: "The Kitchn",
    names: ["the kitchn"],
    slug: "the-kitchn",
    homepage: "https://www.thekitchn.com",
    country: "United States",
    founded: "2005",
    ownershipName: "Dotdash Meredith",
    ownershipType: "Public company division",
    ownershipSummary: "Food and cooking lifestyle site owned by Dotdash Meredith.",
    fundingModel: "Advertising.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "High factuality",
    description:
      "A food and cooking lifestyle publication offering recipes, kitchen tips, and product reviews in an approachable, service-journalism voice.",
    methodologyNote:
      "No political lean applies as this is a lifestyle/food outlet not rated by AllSides, Ad Fontes Media, or MBFC for political bias.",
  },
  {
    displayName: "TheWrap",
    names: ["thewrap"],
    slug: "thewrap",
    homepage: "https://www.thewrap.com",
    country: "United States",
    founded: "2009",
    ownershipName: "TheWrap Inc.",
    ownershipType: "Private company",
    ownershipSummary: "Independently owned entertainment trade publication.",
    fundingModel: "Advertising and subscriptions.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Industry reporting",
    description:
      "TheWrap covers entertainment industry news, including film, television, media business, and awards coverage, with a trade-press editorial voice.",
    methodologyNote:
      "As an entertainment/industry trade outlet rather than general news or politics, AllSides/Ad Fontes/MBFC do not assign it a meaningful political lean.",
  },
  {
    displayName: "Treehugger",
    names: ["treehugger"],
    slug: "treehugger",
    homepage: "https://www.treehugger.com",
    country: "United States",
    founded: "2004",
    ownershipName: "Dotdash Meredith",
    ownershipType: "Public company division",
    ownershipSummary: "Sustainability/environment lifestyle site owned by Dotdash Meredith.",
    fundingModel: "Advertising.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Mixed to high factuality",
    description:
      "Treehugger covers sustainability, environmental science, and eco-friendly lifestyle topics with an explanatory, service-journalism voice.",
    methodologyNote:
      "As a lifestyle/sustainability publication rather than a general news or political outlet, it is not rated by AllSides, Ad Fontes Media, or MBFC for political lean, so no perspective label applies.",
  },
  {
    displayName: "Vogue",
    names: ["vogue"],
    ...
    ownershipName: "Condé Nast",
    ownershipType: "Public company division",
    ownershipSummary: "Fashion and lifestyle publication owned by Condé Nast.",
    fundingModel: "Advertising and subscriptions.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Industry reporting",
    description:
      "Vogue covers fashion, beauty, culture, and lifestyle trends with a glossy, editorial-driven voice aimed at style-conscious audiences.",
    methodologyNote:
      "As a lifestyle and fashion publication, Vogue falls outside the scope of political bias trackers like AllSides, Ad Fontes Media, and MBFC, so no left/right lean applies.",
  },
  {
    displayName: "Women's Health",
    names: ["women's health"],
    slug: "womens-health",
    homepage: "https://www.womenshealthmag.com",
    country: "United States",
    founded: "2005",
    ownershipName: "Hearst Communications",
    ownershipType: "Private company",
    ownershipSummary: "Women's lifestyle magazine owned by Hearst.",
    fundingModel: "Advertising and subscriptions.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Varies by channel",
    description:
      "A lifestyle magazine covering fitness, nutrition, wellness, relationships, and beauty topics aimed at women, with an upbeat, service-oriented editorial voice.",
    methodologyNote:
      "Lifestyle and health publications like this are not rated by AllSides, Ad Fontes Media, or MBFC for political lean, as their content is not general news/politics coverage.",
  },
  {
    displayName: "Yoga Journal",
    names: ["yoga journal"],
    slug: "yoga-journal",
    homepage: "https://www.yogajournal.com",
    country: "United States",
    founded: "1975",
    ownershipName: "Active Interest Media",
    ownershipType: "Private company",
    ownershipSummary: "Wellness lifestyle magazine owned by Active Interest Media.",
    fundingModel: "Advertising and subscriptions.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Industry reporting",
    description:
      "A lifestyle and wellness publication covering yoga practice, meditation, health, and mindful living with an instructional and editorial voice.",
    methodologyNote:
      "Not rated by AllSides, Ad Fontes Media, or MBFC as it is a lifestyle/wellness publication with no meaningful political lean.",
  },
  {
    displayName: "ZDNet",
    names: ["zdnet"],
    ...
    ownershipName: "Ziff Davis",
    ownershipType: "Public company division",
    ownershipSummary: "Enterprise technology publication owned by Ziff Davis.",
    fundingModel: "Advertising.",
    perspectiveKey: "unknown",
    perspectiveLabel: "Not applicable",
    factualityLabel: "Industry reporting",
    description:
      "ZDNet covers enterprise technology, business software, hardware reviews, and IT industry news with a professional, product-focused editorial voice.",
    methodologyNote:
      "As a technology/industry trade publication, ZDNet is not rated for political lean by AllSides, Ad Fontes Media, or MBFC, so no perspective label applies.",
  },
];
