...
export const requestPasswordReset = ({ email }) => requestAuth('POST', { action: 'request-password-reset', email })
export const resetPassword = ({ token, password }) => requestAuth('POST', { action: 'reset-password', token, password })