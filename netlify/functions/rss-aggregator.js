...
function buildManagedSourceRecord(
  feedKey = "news",
  feed = {},
  override = null,
) {
...
function mergeItems(primary = {}, secondary = {}) {
  ...
  return {
    ...
    publishedAt:
      toPlainText(best.publishedAt || other.publishedAt) || "Recently",
  };
}
  ...
  try {
    ...
    if (search && search.trim().length > 0) {
      ...
      const searchBuckets = Array.from(
        new Set([...Object.keys(cache), ...Object.keys(RSS_FEEDS)]),
      );
    ...
    let feedsToFetch = await getEffectiveFeedList(
      activeFeedKey,
      prependBundleFeed(
        RSS_FEEDS[activeFeedKey] || RSS_FEEDS.news,
        activeFeedKey,
      ),
    );
    ...
    if (type === "podcasts") {
      ...
      feedsToFetch = await getEffectiveFeedList(
        activeFeedKey,
        prependBundleFeed(RSS_FEEDS.podcasts || [], activeFeedKey),
      );
      ...
      if (cat === "sports") {
        ...
        feedsToFetch = await getEffectiveFeedList(
          activeFeedKey,
          prependBundleFeed(RSS_FEEDS.sports, activeFeedKey),
        );
        ...
        feedsToFetch = await getEffectiveFeedList(
          activeFeedKey,
          prependBundleFeed(RSS_FEEDS.politics, activeFeedKey),
        );
        console.log(
        ...
        feedsToFetch = await getEffectiveFeedList(
          activeFeedKey,
          prependBundleFeed(RSS_FEEDS.tech, activeFeedKey),
        );
        ...
        feedsToFetch = await getEffectiveFeedList(
          activeFeedKey,
          prependBundleFeed(RSS_FEEDS.business, activeFeedKey),
        );
        console.log(
        ...
        feedsToFetch = await getEffectiveFeedList(
          activeFeedKey,
          prependBundleFeed(RSS_FEEDS.entertainment, activeFeedKey),
        );
        console.log(
        ...
        feedsToFetch = await getEffectiveFeedList(
          activeFeedKey,
          prependBundleFeed(RSS_FEEDS.lifestyle, activeFeedKey),
        );
        console.log(
        ...
        feedsToFetch = await getEffectiveFeedList(
          activeFeedKey,
          prependBundleFeed(RSS_FEEDS.culture, activeFeedKey),
        );
        console.log(
